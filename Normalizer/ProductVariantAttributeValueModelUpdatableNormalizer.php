...
class ProductVariantAttributeValueModelUpdatableNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Starweb\\Sdk\\Model\\ProductVariantAttributeValueModelUpdatable';
    }
    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Starweb\Sdk\Model\ProductVariantAttributeValueModelUpdatable;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Starweb\Sdk\Model\ProductVariantAttributeValueModelUpdatable();
