...
class ProductCategoryModelCollectionMetaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Starweb\\Sdk\\Model\\ProductCategoryModelCollectionMeta';
    }
    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Starweb\Sdk\Model\ProductCategoryModelCollectionMeta;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Starweb\Sdk\Model\ProductCategoryModelCollectionMeta();
