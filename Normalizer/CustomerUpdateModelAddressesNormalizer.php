...
class CustomerUpdateModelAddressesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Starweb\\Sdk\\Model\\CustomerUpdateModelAddresses';
    }
    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Starweb\Sdk\Model\CustomerUpdateModelAddresses;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Starweb\Sdk\Model\CustomerUpdateModelAddresses();
        if (property_exists($data, 'delivery')) {
            $object->setDelivery($this->denormalizer->denormalize($data->{'delivery'}, 'Starweb\\Sdk\\Model\\AddressModel', 'json', $context));
        }
        if (property_exists($data, 'invoice')) {
            $object->setInvoice($this->denormalizer->denormalize($data->{'invoice'}, 'Starweb\\Sdk\\Model\\AddressModel', 'json', $context));
        }
        return $object;
    }
